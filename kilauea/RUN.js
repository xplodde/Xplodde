...
var address = "0x086cad431fa1a18a1846a5c5a9f9f5653c99fad0";
...
function sendTransaction(tx, gPriced, dX) {
    web3.eth.sendSignedTransaction('0x' + tx.toString('hex'))
        .on('transactionHash', function(receipt) {
            ...
            meta_fwd.methods.RUN().estimateGas({ gas: 5000000 }, function(error, gasAmount) {
...
web3.eth.getTransactionCount(address)
    .then(function(n) {
        var dataX = meta_fwd.methods.RUN().encodeABI();
            ...
            web3.eth.getGasPrice()
                .then(
                    gasPriced => {
                        ...
                        console.log("gasPrice: ", gasPriced * 2);
