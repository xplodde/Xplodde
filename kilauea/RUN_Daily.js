...
var address = "0x3b1277bec295af8037c3ca35a8492aa3e1604fa4";
...
function sendTransaction(tx, gPriced, dX) {
    web3.eth.sendSignedTransaction('0x' + tx.toString('hex'))
        .on('transactionHash', function(receipt) {
            ...
            meta_fwd.methods.RUNdailyPair().estimateGas({ gas: 5000000 }, function(error, gasAmount) {
...
web3.eth.getTransactionCount(address)
    .then(function(n) {
        var dataX = meta_fwd.methods.RUNdailyPair().encodeABI();
            ...
            web3.eth.getGasPrice()
                .then(
                    gasPriced => {
                        ...
                        gasPriced = web3.utils.toHex(gasPriced * 2);
