...
var address = "0x8376254eaab14ec4f91d014d79892bb639503fe2";
...
function sendTransaction(tx, gPriced, dX) {
    web3.eth.sendSignedTransaction('0x' + tx.toString('hex'))
        .on('transactionHash', function(receipt) {
            ...
            meta_fwd.methods.liquidations().estimateGas({ gas: 5000000 }, function(error, gasAmount) {
...
web3.eth.getTransactionCount(address)
    .then(function(n) {
        var dataX = meta_fwd.methods.liquidations().encodeABI();
