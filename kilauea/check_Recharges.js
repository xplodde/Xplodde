...
var address = "0xe47bd20476605621A158F21798C7623E322dCC8e";
...
console.log(" ");
console.log("check_Recharges.js");
...
function sendTransaction(tx, gPriced, dX) {
    web3.eth.sendSignedTransaction('0x' + tx.toString('hex'))
        .on('transactionHash', function(receipt) {
            ...
            meta_fwd.methods.checkRecharges().estimateGas({ gas: 5000000 }, async function(error, gasAmount) {
...
web3.eth.getTransactionCount(address)
    .then(function(n) {
        var dataX = meta_fwd.methods.checkRecharges().encodeABI();
            ...
            web3.eth.getGasPrice()
                .then(
                    gasPriced => {
                        ...
                        console.log("gasPriced????", gasPriced);
