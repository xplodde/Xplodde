...
var address = "0x9171e589d609f29fC1c3C708A70d53508025662A";
...
function sendTransaction(tx, gPriced, dX) {
    web3.eth.sendSignedTransaction('0x' + tx.toString('hex'))
        .on('transactionHash', function(receipt) {
            ...
            meta_fwd.methods.xplodingData().estimateGas({ gas: 5000000 }, function(error, gasAmount) {
...
web3.eth.getTransactionCount(address)
    .then(function(n) {
        var dataX = meta_fwd.methods.xplodingData().encodeABI();
            ...
            web3.eth.getGasPrice()
                .then(
                    gasPriced => {
                        ...
                        gasPriced = web3.utils.toHex(gasPriced * 3);
